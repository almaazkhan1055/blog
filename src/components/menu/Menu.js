      ...
      <div className="flex items-center gap-10 font-medium text-base leading-[32px] tracking-[0.75px] text-center cursor-pointer mt-20">
        {["All", "Corporate", "Engineering", "Product"].map((item, index) => (
          <button
            ...
            className={
              index === 0
                ? "bg-[#610BEF] px-6 py-1 rounded-lg text-white sm:text-[18px] text-[10px]"
                : "font-medium sm:text-[18px] text-[10px] leading-[32px] tracking-[0.75px] text-center text-[#6E7191]"
            }
          >
            {item}
          </button>
